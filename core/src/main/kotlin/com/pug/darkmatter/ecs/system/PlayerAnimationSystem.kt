...
class PlayerAnimationSystem(
    ...
    override fun processEntity(entity: Entity, deltaTime: Float) {
        ...
        require(facing != null) { "Entity |entity| must have a Facing Component. entity=$entity" }
        val graphic = entity[GraphicComponent.mapper]
        require(graphic != null) { "Entity |entity| must have a Graphic Component. entity=$entity" }
