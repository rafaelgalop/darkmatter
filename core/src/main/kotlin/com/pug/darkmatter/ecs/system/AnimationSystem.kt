...
import com.pug.darkmatter.ecs.component.Animation2D
import com.pug.darkmatter.ecs.component.AnimationComponent
import com.pug.darkmatter.ecs.component.AnimationType
...
class AnimationSystem(
    ...
    private fun getAnimation(type: AnimationType): Animation2D {
        ...
        if(animation ==null){
            ...
            if(regions.isEmpty){
                ...
                LOG.debug { "Adding animation of $type with ${regions.size} regions" }
            }
    ...
    override fun processEntity(entity: Entity, deltaTime: Float) {
        ...
        if(aniCmp.type ==AnimationType.NONE){
            LOG.error { "No type specified for the animation component $aniCmp for |entity| $entity" }
            return
        }
        if(aniCmp.type == aniCmp.animation.type){
            // animation is properly set
